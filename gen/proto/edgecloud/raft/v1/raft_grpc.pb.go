...
const (
	Raft_RequestVote_FullMethodName   = "/edgecloud.raft.v1.Raft/RequestVote"
	Raft_AppendEntries_FullMethodName = "/edgecloud.raft.v1.Raft/AppendEntries"
)
...
//
// Raft RPCs (placeholder; expand during implementation).
...
var Raft_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "edgecloud.raft.v1.Raft",
	...
	Metadata: "edgecloud/raft/v1/raft.proto",
}
